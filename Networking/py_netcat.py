...
def usage():
    ...
    print()
    print("Examples: ")
    print("py_netcat.py -t 192.168.0.1 -p 5555 -l -c")
    print("py_netcat.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("py_netcat.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFGHI' | ./py_netcat.py -t 192.168.11.12 -p 135")
    sys.exit(0)
